    ...
    <div class="admin-content">
        ...
        <div class="am-cf am-padding">
            <div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">系统管理</strong> /
                <a href="javascript:openBankWin();"><small>日志查看</small></a>
            </div>
        </div>
        <div class="am-cf">
...
//            lengthMenu: [ [-1,10, 25, 50], ["All",10, 25, 50] ], //自定义每页数量的时候,下拉菜单的选项
            ajax: {
                url: "${ctx}/backstage/logging/list.json",
                data: function (data) {
            ...
            columns: [
                {data: "eventId", sTitle: "eventId", name: 'event_id'},
                {data: "loggerName",sTitle: "名称",orderable: false},
                {data: "threadName",sTitle: "线程",orderable: false},
                {data: "formattedMessage",sTitle: "简述",orderable: false},
                {data: "levelString",sTitle: "级别", orderable: false},
                {data: "timestmp",sTitle: "创建时间",name:'timestmp',
            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, full) {
                        return '<div class=am-btn-toolbar data-id="' + full.eventId + '"><div class="am-btn-group am-btn-group-xs">' +
                                '<button onclick="" class="am-btn am-btn-default am-btn-xs am-text-secondary detailBtn"><span class="am-icon-info-circle"></span>详情</button>' +
                                '</div></div>';
                    }
                }
            ]
        ...
        $("#listTable").on('click', '.detailBtn', function () {
            ...
            $.getJSON("${ctx}/backstage/logging/detail.json?eventId="+dataId,function(rep){
